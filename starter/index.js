...
function greatestProfitChange(finances) {
  ...
  return `Greatest Increase in Profits: ${maxProfitMonth}-${maxProfitYear} (${maxProfit})

Greatest Decrease in Profits: ${minProfitMonth}-${minProfitYear} (${minProfit})`;
}

console.log(greatestProfitChange(finances));
